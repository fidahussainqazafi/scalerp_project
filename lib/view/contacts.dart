            ...
            Row(
              children: [
                ...
                StartButton(
                 ...
                 SizedBox(width: 66.w,),
                Text(suppliers,style: TextStyle(color: ligColor,fontSize: 12.sp,
                fontWeight: FontWeight.w500),)
              ],
            ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  sizedBox: SizedBox(width: 40.w)),
                  SizedBox(height: 10.h,),
                  Row(

                    children: [
                      SizedBox(width: 235.w,),
                      const Icon(Icons.calendar_month,color: ligColor,),
                      SizedBox(width: 4.w),
                      const Text(addFollowUp,style: TextStyle(color: whiteColor),),
                    ],
                  ),
                ],
              ),
